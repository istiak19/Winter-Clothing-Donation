...
const About = () => {
    ...
    return (
        <div className="w-11/12 mx-auto text-center px-4 py-12">
            ...
            <h3 className="text-2xl font-semibold text-[#1CABE2] mb-4" data-aos="fade-up">How You Can Contribute</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="p-6 border border-[#1CABE2] rounded-lg shadow-lg" data-aos="flip-left">
                ...
                <div className="p-6 border border-[#1CABE2] rounded-lg shadow-lg" data-aos="flip-left" data-aos-delay="200">
                ...
                <div className="p-6 border border-[#1CABE2] rounded-lg shadow-lg" data-aos="flip-left" data-aos-delay="400">
